...
if __name__ == "__main__":
        ...
        for day in days:
            ...
            for group in tqdm(groups):
                ...
                for non_group in group_encounters:
                    ...
                    ng_curv = compute_curvature_v2(traj_non_group_vicinity)
                    ...
                    group_curv = compute_curvature_v2(traj_group_vicinity)
                    if(PLOT_VERIF) :
    ...
    pickle_save(f"../data/pickle/{env_name_short}_encounters_curvature_v2.pkl", dict_curvature)
