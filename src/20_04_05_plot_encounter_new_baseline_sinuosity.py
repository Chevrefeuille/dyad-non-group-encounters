...
if __name__ == "__main__":
    ...
    for env_name in ["diamor:corridor"]:
        ...
        for i in range(5):
            ...
            plt.savefig(f"../data/figures/deflection/will/boxplot/versus/all/sinuosity/encounter_new_baseline_{env_name_short}_{SOC_BINDING_NAMES[i]}.png")
            plt.close()
            ...
            plt.savefig(f"../data/figures/deflection/will/boxplot/versus/mean/sinuosity/encounter_new_baseline_mean_{env_name_short}_{SOC_BINDING_NAMES[i]}.png")
            plt.close()
