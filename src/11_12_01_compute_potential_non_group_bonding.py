...
if __name__ == "__main__":
    ...
    for env_name in ["atc:corridor", "diamor:corridor"]:
        ...
        plt.savefig(
            f"../data/figures/intrusion/potentials/non_groups/potential_groups_vs_non_groups_bond_{env_name_short}.png"
        )
        plt.show()
        ...
        # plt.savefig(
        #     f"../data/figures/intrusion/potentials/potential_{env_name_short}.png"
        # )
        plt.show()
