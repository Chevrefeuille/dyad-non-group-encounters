...
if __name__ == "__main__":
    ...
    for env_name in ["diamor:corridor"]:
        ...
        global_mean_all_new_baseline_length = np.around(np.nanmean(flattened_new_baseline_length) /1000, 4) 
        ...
        global_mean_all_new_baseline_time = np.around(np.nanmean(flattened_new_baseline_time)/1000, 4)
