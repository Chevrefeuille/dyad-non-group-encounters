...
""" The goal of this script is to compute the relative orientation of the groups without interaction in the corridor environment.
The relative orientation is the angle between the two pedestrians in the group.
"""
