...
if __name__ == "__main__":
        ...
        for day in days:
            ...
            for group in tqdm(groups):
                ...
                for non_group in group_encounters:
                    ...
                    ng_curv = compute_curvature(traj_non_group_vicinity[:,1:3])
                    ...
                    group_curv = compute_curvature(traj_group_vicinity[:,1:3])
    ...
    pickle_save(f"../data/pickle/{env_name_short}_encounters_curvature.pkl", dict_curvature)
